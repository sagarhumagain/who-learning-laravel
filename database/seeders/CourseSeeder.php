...
class CourseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $courses = [
            ...
            ['name'=> "Clinical Management COVID-19: Mild, Moderate, Severe",'source' => 'Open WHO','course_categories' =>['Clinical Management Channel - OPTIONAL'],'url' => 'https://openwho.org/courses/clinical-management-COVID-19-mild-mod-severe','credit_hours' =>3,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "Clinical Management COVID-19: Initial Approach",'source' => 'Open WHO','course_categories' =>['Clinical Management Channel - OPTIONAL'],'url' => 'https://openwho.org/courses/clinical-management-COVID-19-initial-approach','credit_hours' =>6,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=>  "Clinical Management COVID-19: Rehabilitation",'source' => 'Open WHO','course_categories' =>['Clinical Management Channel - OPTIONAL'],'url' => 'https://openwho.org/courses/clinical-management-COVID-19-rehabilitation','credit_hours' =>3,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "Clinical Management COVID-19: General Considerations",'source' => 'Open WHO','course_categories' =>['Clinical Management Channel - OPTIONAL'],'url' => 'https://openwho.org/courses/clinical-management-COVID-19-general-considerations','credit_hours' => 3,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "Clinical Management COVID-19: Case Management",'source' => 'Open WHO','course_categories' =>['Clinical Management Channel - OPTIONAL'],'url' => 'https://openwho.org/courses/seasonal-influenza-clinical-management','credit_hours' => 4,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "RCCE COVID-19",'source' => 'Open WHO','course_categories' =>['Risk Communication'],'url' => 'https://openwho.org/courses/RCCE-COVID-19','credit_hours' =>2,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "Infodemic Management 101",'source' => 'Open WHO','course_categories' =>['Risk Communication'],'url' => 'https://openwho.org/courses/infodemic-management-101','credit_hours' =>4,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "Risk Communication Essentials",'source' => 'Open WHO','course_categories' =>['Risk Communication'],'url' => 'https://openwho.org/courses/risk-communication','credit_hours' =>8,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "Key considerations for SARS-CoV-2 antigen RDT implementation",'source' => 'Open WHO','course_categories' =>['Lab-related'],'url' => 'https://openwho.org/courses/SARS-CoV-2-Ag-RDT-implementation','credit_hours' => 2,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "SARS-CoV-2 Ag RDT",'source' => 'Open WHO','course_categories' =>['Lab-related'],'url' => 'https://openwho.org/courses/SARS-CoV-2-Ag-RDT','credit_hours' =>2.5,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "IPC leadership EN",'source' => 'Open WHO','course_categories' =>['Infection Prevention and Control Channel'],'url' => 'https://openwho.org/courses/IPC-leadership-EN','credit_hours' =>4,"description" => "","due_date" => null,"is_approved" => 1,],
            ['name'=> "IPC CC MMIS EN",'source' => 'Open WHO','course_categories' =>['Infection Prevention and Control Channel'],'url' => 'https://openwho.org/courses/IPC-CC-MMIS-EN','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1,],
            ...
            ['source' => 'Open WHO','course_categories' =>['OSL'],'url' => 'https://openwho.org/courses/cholera-kits ','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1,
             'name' => "Cholera kits"],
            ['source' => 'Open WHO','course_categories' =>['Preparing for Pandemics Channel'],'url' => 'https://openwho.org/courses/influenza-prevention-control','credit_hours' =>0.5,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Influenza Prevention Control" ],
            ['source' => 'Open WHO','course_categories' =>['Preparing for Pandemics Channel'],'url' => 'https://openwho.org/courses/influenza-sentinel-surveillance','credit_hours' =>14,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Influenza Sentinel Surveillance" ],
            ['source' => 'Open WHO','course_categories' =>['Preparing for Pandemics Channel'],'url' => 'https://openwho.org/courses/avian-and-other-zoonotic-influenza-introduction ','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Avian and other zoonotic influenza introduction" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/covid-19-intra-action-review-en','credit_hours' =>2,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "COVID-19 Intra Action Review" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/WHO-COVID-19-mass-gatherings-risk-assessment-training','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1, 'name' =>  "WHO COVID-19 mass gatherings risk assessment training" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/hedrm-in-cities','credit_hours' =>1.5,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "HEDRM in cities" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/SOPs-for-emergencies','credit_hours' =>6.5,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "SOPs for emergencies" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/ready4response-tier1-EN','credit_hours' =>7,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Ready4response Tier1" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/PHEOC-EN','credit_hours' =>3,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "PHEOC" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/health-cluster','credit_hours' =>9,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Health Cluster" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/incident-management-system','credit_hours' =>3,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Incident Management System" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/incident-management-system-tier2','credit_hours' =>3,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Incident Management System Tier2" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/operational-readiness-introduction','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Operational Readiness Introduction" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/simex','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "Simex" ],
            ['source' => 'Open WHO','course_categories' =>['Ready for Response Channel'],'url' => 'https://openwho.org/courses/AAR-en','credit_hours' =>1,"description" => "","due_date" => null,"is_approved" => 1, 'name' => "AAR" ],
        ...
        foreach ($courses as $course) {
            $createdCourse = Course::create(
                [
                  'name' => $course['name'],  'description' => $course['description'],  'credit_hours' => $course['credit_hours'],  'source' => $course['source'],  'url' => $course['url'],  'due_date' => $course['due_date'],  'is_approved' => $course['is_approved']
                ]
            );
            ...
            if (isset($course['course_categories'])) {
                foreach ($course['course_categories'] as $courseCategory) {
                    ...
                    CourseCourseCategory::create([
                        "course_id" => $createdCourse->id,        "course_category_id" => $courseCategoryId
                    ]);
                }
            }
